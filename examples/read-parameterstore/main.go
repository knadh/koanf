...
func main() {
	...
	// config for parameterstore provider
	cofig := parameterstore.Config{
		Name:  "DEV_TEST",
	...
	provider := parameterstore.Provider(cofig , func(s string) string { return strings.ToLower(strings.TrimPrefix(s, "DEV_")) }) 
