...
// Allocs begin from the name of the task group.
// For example, if we have task group "echo" with 2 instances,
// we can get its data, using the path:
// echo0.ID
// echo0.Network0.IP
// echo0.Network0.Port0
// echo1.ID
// echo1.Network0.IP
// echo1.Network0.Port0
// echo1.Network0.Port1
...
// Raft configuration path starts from "server0", "server1", etc.
// Example:
// server0.ID
// server1.Address
...
// databases/sql - the path of a Nomad variable
// mysql, postgresql - keys
